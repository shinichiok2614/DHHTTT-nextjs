...
import { clearToken } from 'src/helpers/storage'
...
const UserDropdown = () => {
  ...
  console.log('accountSelector.accountData?.email')
  console.log(accountSelector.accountData?.email)
  return (
    <Fragment>
      <Badge
        ...
        <Box sx={{ pt: 2, pb: 3, px: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', marginLeft: 3, alignItems: 'flex-start', flexDirection: 'column' }}>
              <Typography sx={{ fontWeight: 600 }}>{accountSelector.accountData?.email}</Typography>
